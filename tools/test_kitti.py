...
from mmdet3d.apis.test_kitti import custom_single_gpu_test_kitti, custom_multi_gpu_test_kitti
...
def main():
    ...
    if not distributed:
        ...
        if cfg.get('use_custom_gpu_test', True):
            outputs = custom_multi_gpu_test_kitti(model, data_loader, args.tmpdir,
                                 args.gpu_collect)
        else:
