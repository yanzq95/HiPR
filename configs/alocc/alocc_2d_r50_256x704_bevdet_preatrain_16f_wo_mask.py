...
# +----------------------+----------+----------+----------+
# |        others        |  0.129   |  0.137   |  0.139   |
# |       barrier        |  0.455   |  0.494   |  0.510   |
# |       bicycle        |  0.272   |  0.306   |  0.318   |
# |         bus          |  0.580   |  0.682   |  0.741   |
# |         car          |  0.546   |  0.616   |  0.647   |
# | construction_vehicle |  0.241   |  0.346   |  0.392   |
# |      motorcycle      |  0.275   |  0.358   |  0.386   |
# |      pedestrian      |  0.350   |  0.404   |  0.425   |
# |     traffic_cone     |  0.350   |  0.372   |  0.382   |
# |       trailer        |  0.268   |  0.348   |  0.447   |
# |        truck         |  0.483   |  0.579   |  0.625   |
# |  driveable_surface   |  0.609   |  0.684   |  0.760   |
# |      other_flat      |  0.360   |  0.408   |  0.449   |
# |       sidewalk       |  0.317   |  0.375   |  0.427   |
# |       terrain        |  0.306   |  0.382   |  0.446   |
# |       manmade        |  0.447   |  0.524   |  0.574   |
# |      vegetation      |  0.319   |  0.436   |  0.518   |
# +----------------------+----------+----------+----------+
# |         MEAN         |  0.371   |  0.438   |  0.482   |
# +----------------------+----------+----------+----------+
# {'RayIoU': 0.4302368461868848, 'RayIoU@1': 0.3708483066218764, 'RayIoU@2': 0.4383268247235873, 'RayIoU@4': 0.48153540721519095}
...
# ===> bus - IoU = 42.696
# ===> car - IoU = 49.683
# ===> construction_vehicle - IoU = 27.0927
# ===> motorcycle - IoU = 29.8641
# ===> pedestrian - IoU = 29.0029
# ===> traffic_cone - IoU = 35.2342
# ===> trailer - IoU = 32.018
# ===> truck - IoU = 38.3473
# ===> driveable_surface - IoU = 62.9655
# ===> other_flat - IoU = 44.5903
# ===> sidewalk - IoU = 45.0555
# ===> terrain - IoU = 39.2417
# ===> manmade - IoU = 34.6046
# ===> vegetation - IoU = 30.3141
# ===> free - IoU = 85.6475
# ===> mIoU of 6019 samples: 37.36
# ===> occupied - IoU = 50.0082
# ===> mIoU_D = 34.8953
