...
# ===> bus - IoU = 27.3061
# ===> car - IoU = 30.6582
# ===> construction_vehicle - IoU = 12.717
# ===> motorcycle - IoU = 17.365
# ===> pedestrian - IoU = 15.7506
# ===> traffic_cone - IoU = 13.9523
# ===> trailer - IoU = 13.8718
# ===> truck - IoU = 22.3545
# ===> driveable_surface - IoU = 40.0339
# ===> other_flat - IoU = 24.6525
# ===> sidewalk - IoU = 26.2985
# ===> terrain - IoU = 24.44
# ===> manmade - IoU = 14.4231
# ===> vegetation - IoU = 22.3182
# ===> free - IoU = 93.4985
# ===> mIoU of 6019 samples: 21.47
# ===> mIoU_D = 19.461
# ===> occupied - IoU = 31.45
...
test_pipeline = [
    dict(
        ...
        tta=False,
        transforms=[
            dict(type='PrepareImageInputs', data_config=data_config, sequential=depth_stereo,gts_surroundocc=gts_surroundocc),
            dict(
                type='LoadAnnotationsBEVDepth',
                bda_aug_conf=bda_aug_conf,
                classes=class_names,
            ...
            dict(
                ...
                with_label=False),
            dict(type='Collect3D', keys=['points', 'img_inputs','aux_cam_params',  'gt_occupancy'])
            ]
        )
]
