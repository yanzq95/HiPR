...
# +----------------------+----------+----------+----------+
# |        others        |  0.129   |  0.138   |  0.139   |
# |       barrier        |  0.466   |  0.509   |  0.529   |
# |       bicycle        |  0.268   |  0.310   |  0.319   |
# |         bus          |  0.557   |  0.664   |  0.728   |
# |         car          |  0.556   |  0.632   |  0.661   |
# | construction_vehicle |  0.258   |  0.361   |  0.405   |
# |      motorcycle      |  0.245   |  0.318   |  0.345   |
# |      pedestrian      |  0.358   |  0.417   |  0.441   |
# |     traffic_cone     |  0.365   |  0.391   |  0.403   |
# |       trailer        |  0.287   |  0.381   |  0.457   |
# |        truck         |  0.486   |  0.587   |  0.633   |
# |  driveable_surface   |  0.623   |  0.694   |  0.762   |
# |      other_flat      |  0.361   |  0.405   |  0.442   |
# |       sidewalk       |  0.333   |  0.390   |  0.438   |
# |       terrain        |  0.328   |  0.404   |  0.466   |
# |       manmade        |  0.458   |  0.539   |  0.590   |
# |      vegetation      |  0.339   |  0.455   |  0.537   |
# +----------------------+----------+----------+----------+
# |         MEAN         |  0.377   |  0.447   |  0.488   |
# +----------------------+----------+----------+----------+
# {'RayIoU': 0.43742139758652554, 'RayIoU@1': 0.3773897926080265, 'RayIoU@2': 0.4468048128360853, 'RayIoU@4': 0.48806958731546457}
...
# ===> bus - IoU = 42.1072
# ===> car - IoU = 50.2558
# ===> construction_vehicle - IoU = 27.7404
# ===> motorcycle - IoU = 31.6386
# ===> pedestrian - IoU = 29.8154
# ===> traffic_cone - IoU = 36.3023
# ===> trailer - IoU = 32.9689
# ===> truck - IoU = 38.7247
# ===> driveable_surface - IoU = 64.8031
# ===> other_flat - IoU = 44.3771
# ===> sidewalk - IoU = 46.9334
# ===> terrain - IoU = 42.4565
# ===> manmade - IoU = 35.5761
# ===> vegetation - IoU = 32.3267
# ===> free - IoU = 86.0616
# ===> mIoU of 6019 samples: 38.29
# ===> occupied - IoU = 51.98
# ===> mIoU_D = 35.5902
