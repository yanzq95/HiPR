...
# +----------------------+----------+----------+----------+
# |        others        |  0.121   |  0.132   |  0.135   |
# |       barrier        |  0.430   |  0.478   |  0.497   |
# |       bicycle        |  0.217   |  0.254   |  0.267   |
# |         bus          |  0.510   |  0.621   |  0.682   |
# |         car          |  0.515   |  0.594   |  0.626   |
# | construction_vehicle |  0.193   |  0.313   |  0.369   |
# |      motorcycle      |  0.233   |  0.317   |  0.340   |
# |      pedestrian      |  0.311   |  0.375   |  0.397   |
# |     traffic_cone     |  0.310   |  0.337   |  0.349   |
# |       trailer        |  0.227   |  0.308   |  0.409   |
# |        truck         |  0.448   |  0.555   |  0.608   |
# |  driveable_surface   |  0.573   |  0.654   |  0.739   |
# |      other_flat      |  0.317   |  0.366   |  0.409   |
# |       sidewalk       |  0.284   |  0.341   |  0.395   |
# |       terrain        |  0.264   |  0.338   |  0.408   |
# |       manmade        |  0.380   |  0.466   |  0.523   |
# |      vegetation      |  0.258   |  0.375   |  0.464   |
# +----------------------+----------+----------+----------+
# |         MEAN         |  0.329   |  0.401   |  0.448   |
# +----------------------+----------+----------+----------+
# {'RayIoU': 0.39277806935272014, 'RayIoU@1': 0.32898795627579547, 'RayIoU@2': 0.401347303679773, 'RayIoU@4': 0.44799894810259194}
...
# ===> bus - IoU = 40.4507
# ===> car - IoU = 46.8836
# ===> construction_vehicle - IoU = 22.59
# ===> motorcycle - IoU = 26.6188
# ===> pedestrian - IoU = 26.6391
# ===> traffic_cone - IoU = 29.7296
# ===> trailer - IoU = 25.9199
# ===> truck - IoU = 35.5358
# ===> driveable_surface - IoU = 59.8183
# ===> other_flat - IoU = 41.28
# ===> sidewalk - IoU = 42.099
# ===> terrain - IoU = 36.0724
# ===> manmade - IoU = 24.6959
# ===> vegetation - IoU = 23.6661
# ===> free - IoU = 83.8558
# ===> mIoU of 6019 samples: 33.38
# ===> occupied - IoU = 44.2402
# ===> mIoU_D = 31.3377
