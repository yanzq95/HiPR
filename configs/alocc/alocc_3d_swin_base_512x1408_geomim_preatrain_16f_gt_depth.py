...
# ===> bus - IoU = 65.5229
# ===> car - IoU = 70.8524
# ===> construction_vehicle - IoU = 42.0602
# ===> motorcycle - IoU = 56.1898
# ===> pedestrian - IoU = 61.5301
# ===> traffic_cone - IoU = 52.5809
# ===> trailer - IoU = 54.3929
# ===> truck - IoU = 61.5271
# ===> driveable_surface - IoU = 88.2843
# ===> other_flat - IoU = 55.3269
# ===> sidewalk - IoU = 64.8474
# ===> terrain - IoU = 67.928
# ===> manmade - IoU = 74.1748
# ===> vegetation - IoU = 70.1712
# ===> free - IoU = 96.233
# ===> mIoU of 6019 samples: 59.95
# ===> occupied - IoU = 87.8349
# ===> mIoU_D = 57.8172
...
model = dict(
    ...
    img_backbone=dict(
        ...
        embed_dims=128,
        # init_cfg=dict(
        #     checkpoint='/path/to/geomim_base.pth',
        #     type='Pretrained'
        # ),
        num_heads=[4,8,16,32],
        out_indices=[2,3],
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        num_layers=24, layer_decay_rate=0.85,
        custom_keys={
            'absolute_pos_embed': dict(decay_mult=0.),
            'relative_position_bias_table': dict(decay_mult=0.),
            'norm': dict(decay_mult=0.)
        }))
optimizer_config = dict(grad_clip=dict(max_norm=5, norm_type=2), max_keep_ckpts=1)
lr_config = dict(
    policy='step',
    warmup='linear',
    warmup_iters=200,
