...
__all__ = ['SequentialControlHookMulti']


@HOOKS.register_module()
class SequentialControlHookMulti(Hook):
    """ """
    ...
    def set_temporal_flag_v2(self, runner, flag):
        ...
        if is_parallel(runner.model.module):
            ...
            runner.model.module.module.forward_projection.do_history=flag
            runner.model.module.module.do_history=flag
        else:
            runner.model.module.forward_projection.do_history = flag
