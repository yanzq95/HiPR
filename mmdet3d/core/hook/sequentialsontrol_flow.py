...
__all__ = ['SequentialControlHookFlow']


@HOOKS.register_module()
class SequentialControlHookFlow(Hook):
    """ """
    ...
    def set_temporal_flag_v2(self, runner, flag):
        if is_parallel(runner.model.module):
            runner.model.module.module.alocc_head.do_history=flag
            runner.model.module.module.do_history=flag
        else:
            runner.model.module.alocc_head.do_history = flag
