...
class SequentialControlHook(Hook):
    ...
    def set_temporal_flag_v2(self, runner, flag):
        if is_parallel(runner.model.module):
            ...
            if hasattr(runner.model.module.module,'fuse_history_func'):
                runner.model.module.module.fuse_history_func.do_history=flag
        else:
            runner.model.module.do_history = flag
            # import pdb;pdb.set_trace()
            if hasattr(runner.model.module,'fuse_history_func'):
                runner.model.module.fuse_history_func.do_history=flag
