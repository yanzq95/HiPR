...
class BackwardProjection_HGR(BaseModule):
    """Head of Detr3D.
    Args:
    ...
    def forward(self, mlvl_feats, img_metas, lss_bev=None, gt_bboxes_3d=None, cam_params=None, pred_img_depth=None, bev_mask=None, **kwargs):
        """Forward function.
        Args:
