...
class InfiniteGroupEachSampleInBatchSampler(Sampler):
    ...
    def __init__(self, 
        ...
        self.random_reverse_group=random_reverse_group
        ...
        while True:
            ...
            for local_sample_idx in range(self.batch_size):
                if len(self.buffer_per_local_sample[local_sample_idx]) == 0:
                    ...
                    if self.random_reverse_group:
                        new_group=new_group[::-1]
                    self.buffer_per_local_sample[local_sample_idx] = new_group
