...
class CustomDistMultiScaleFlipAug3D(object):
    ...
    def __init__(self,
        ...
        # print(self.tta_config,55555555555)
    ...
    def __call__(self, results):
        ...
        # print(f"rank: {_rank}, world_size: {_world_size}",'hereherehere')
        # if self.tta: assert _world_size == 1
        aug_data = []
        ...
        if self.tta_config is not None:
            flip_aug, flip_dx_aug, flip_dy_aug = self.tta_config
        # print(flip_aug, flip_dx_aug, flip_dy_aug,22222222222)
        for flip in flip_aug:
            for flip_dx in flip_dx_aug:
                for flip_dy in flip_dy_aug:
                        # for direction in self.flip_direction:
