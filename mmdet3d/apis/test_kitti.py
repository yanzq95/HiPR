...
from ..utils import cm_to_ious, format_results, SSCMetrics

# utils for saving predictions 
from .utils import *

def custom_single_gpu_test_kitti(model, data_loader, show=False, out_dir=None, show_score_thr=0.3, pred_save=None, test_save=None):
    model.eval()
...
def custom_multi_gpu_test_kitti(model, data_loader, tmpdir=None, gpu_collect=False, pred_save=None, test_save=None):
